            ...
            <div class='row'>
              <div class='col-lg-7 pt-5 pt-lg-0 order-2 order-lg-1 d-flex align-items-center'>
                <div data-aos='zoom-out'>
                  <h1>
                    Analyse your Competitive Programming with{' '}
                    <span>Envision</span>
                  </h1>
                  <h2>
                    We are here to help you showcase your talent and analyse you
                    Competitive Programming skills along with your friends{' '}
                  </h2>
